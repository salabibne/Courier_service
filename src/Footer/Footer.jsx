    ...
    return (
        <div>
            <footer className="footer p-10 bg-neutral text-neutral-content">
                ...
                <nav>
                    <header className="footer-title text-lg">Head Office</header>
                   
                      <p className="font-bold">1234,Abc,Dhaka,Bangladesh</p>
                      
                </nav>
                <nav>
                    <header className="footer-title text-lg">Information</header>
                    <div className="">
                ...
                <p>Pictures are taken from FREEPIK</p>
                </div>
